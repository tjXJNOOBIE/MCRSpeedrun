...
public abstract class AbstractEvent {
    ...
    private static final List<com.tjxjnoobie.events.interfaces.EventListener<?>> listeners = new CopyOnWriteArrayList<>();
    private static final List<Consumer<AbstractEvent>> middleware = new CopyOnWriteArrayList<>();
    ...
    public void logException(Throwable ex) {
        System.err.println("[Event Error] " + this.getClass().getSimpleName() + " threw an exception:");
