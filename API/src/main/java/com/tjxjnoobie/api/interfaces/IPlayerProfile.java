...
public interface IPlayerProfile {
    ...
    String getUUIDFromUsername(String punishTable, String targetName, String punishTable1);

    boolean playerExistsFromUsername(String targetName, String punish, String punish1);
}