 ...
 * @since 10/12/2025
 */
public interface IDependencyInjectorHelper<CLASS extends IDependencyClass<?>,
    ...
    default Set<Class<? extends CLASS>> scanFromBasePackage(String basePackage, ClassLoader loader){
        return new HashSet<>();
    }
//
...
//    }
    ...
    default void registerDependenciesViaAnnotation(Set<Class<?extends CLASS>> classesToScan) throws
     NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {

    }
    default Set<Class<? extends CLASS>> findMatchingConcreteForInterface(IDependencyClass<CLASS> subIface){
        return null;
    }
