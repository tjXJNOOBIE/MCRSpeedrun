...
@DelegatesToInterface(getClassForDelegation = IGlobalContext.class)
public class GlobalContext extends AbstractContext<IGlobalContext> implements IGlobalContext, IContext<IGlobalContext>, IAbstractClassMetaData<IGlobalContext> {
    ...
    //TODO: A instance (even lazy) based context sustem is now obsolete with class scanning DI
    // in place, evaluate class to determine usage.
...
//        System.out.println("Loaded Dependencies: "+getDependencyMap().toString());
//        System.out.println("---------------------------------------");
    }
