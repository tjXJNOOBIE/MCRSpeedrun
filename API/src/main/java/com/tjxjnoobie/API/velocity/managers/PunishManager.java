package com.tjxjnoobie.API.velocity.managers;
    ...
    public void cacheAllPunishments() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String banStartStr = utils.formatTimestamp(banStart, formatter);
                String banEndStr = utils.formatTimestamp(banEnd, formatter);
                String warnStartStr = utils.formatTimestamp(warnStart, formatter);
                String warnEndStr = utils.formatTimestamp(warnEnd, formatter);
                String muteStartStr = utils.formatTimestamp(muteStart, formatter);
                String muteEndStr = utils.formatTimestamp(muteEnd, formatter);
