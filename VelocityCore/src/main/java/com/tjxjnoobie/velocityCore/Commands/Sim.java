...
import com.tjxjnoobie.API.utils.RatingCalculator;
import com.tjxjnoobie.API.utils.RatingPeriodResults;
import com.tjxjnoobie.API.utils.Utils;
import com.velocitypowered.api.command.SimpleCommand;

import java.util.*;

public class Sim implements SimpleCommand {
    ...
    public Sim(Rating rating, Utils utils) {
        this.rating = rating;
        this.utils = utils;
    }
